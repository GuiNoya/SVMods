            ...
            switch ((AnimalsTaskId)TaskId)
            {
                case AnimalsTaskId.UnpettedAnimals:
                    ...
                    foreach (var animal in UnpettedAnimals)
                    {
                        rpItem.Add(new ReportReturnItem
                        {
                            ...
                            WarpTo = new Tuple<string, int, int>(animal.Location.Name, animal.Object.getTileX(), animal.Object.getTileY())
                        });
                ...
                case AnimalsTaskId.PondsNeedingAttention:
                    ...
                    foreach (FishPond fpond in PondsNeedingAttention)
                    {
                        rpItem.Add(new ReportReturnItem
                        {
                            ...
                            WarpTo = new Tuple<string, int, int>("Farm", fpond.tileX + fpond.tilesWide - 1, fpond.tileY + fpond.tilesHigh)
                        });
                    }
                ...
                case AnimalsTaskId.AnimalProducts:
                    ...
                    foreach (var animal in AnimalProductsToHarvest)
                    {
                        ...
                        rpItem.Add(new ReportReturnItem
                        {
                            Label = $"{animal.Object.displayType} {animal.Object.displayName}" + I18n.Tasks_Animal_Has() + $"{ObjectsNames[currentProduce]}" + I18n.Tasks_At() + $"{ animal.Location.Name} ({animal.Object.getTileX()}, {animal.Object.getTileY()})",
                            WarpTo = new Tuple<string, int, int>(animal.Location.Name, animal.Object.getTileX(), animal.Object.getTileY())
                        });
                    }
                    ...
                    foreach (var product in AnimalProductsToCollect)
                    {
                        ...
                        rpItem.Add(new ReportReturnItem
                        {
                            ...
                            WarpTo = new Tuple<string, int, int>(product.Location.Name, (int)product.Position.X, (int)product.Position.Y)
                        });
                    }
                        ...
                        rpItem.Add(new ReportReturnItem
                        {
                            ...
                            WarpTo = new Tuple<string, int, int>(
                              ...
                              tuple.Item1.indoors.Value.NameOrUniqueName,
                               (int)tuple.Item1.tileX,
                                (int)tuple.Item1.tileY
                            )
                        });
                    }
                    break;
